                    ...
                    <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                        ...
                        <div class="flex gap-4 shrink-0">
                            <div class="bg-white/5 border border-white/10 rounded-2xl px-5 py-3.5 text-center backdrop-blur-xs min-w-28">
                                <span class="block text-[9px] font-bold text-[#C5A880] uppercase tracking-widest mb-1">{{ t('packages') }}</span>
                                <span class="text-2xl font-semibold font-serif-luxury text-white">{{ variations.length }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="border-t border-[#E6E1DA] pt-4 sm:pt-6">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                                        ...
                                        >
                                            ...
                                            >
                                                <i class="fas text-[10px]" :class="getDishIcon(item).icon"></i>
                                            </span>
                                            <span class="text-xs text-[#2D3330] font-medium tracking-wide leading-tight">{{ item }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-5 bg-[#FAF8F5] p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-[#E6E1DA] flex flex-col justify-between gap-4 sm:gap-6 self-stretch shadow-xs">
                                <div class="space-y-5">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center shadow-xs rounded-xl overflow-hidden border border-[#E6E1DA]">
                                            <!-- Minus Button -->
                                            <button 
                                                type="button"
                                                @click="adjustGuests(pkg.id || pkg.package_id, -50, pkg.min_order || 20)"
                                                class="w-12 h-12 bg-white text-[#5C6460] hover:text-[#4A6B5D] hover:bg-[#FAF7F2] transition-colors flex items-center justify-center font-semibold text-lg cursor-pointer focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed border-r border-[#E6E1DA]"
                                            ...
                                            <input 
                                                ...
                                                class="w-24 text-center font-bold text-lg border-0 h-12 focus:outline-none focus:ring-0 bg-white text-[#2D3330]"
                                            />
                                            ...
                                            <button 
                                                ...
                                                class="w-12 h-12 bg-white text-[#5C6460] hover:text-[#4A6B5D] hover:bg-[#FAF7F2] transition-colors flex items-center justify-center font-semibold text-lg cursor-pointer focus:outline-none border-l border-[#E6E1DA]"
                                            >
                                    ...
                                    <div class="flex items-center gap-2 mt-1">
                                        <span 
                                            class="text-[10px] font-semibold px-2.5 py-1 rounded-full transition-all duration-300 flex items-center gap-1.5"
                                            :class="getScaleBadge(quantities[pkg.id || pkg.package_id], pkg.min_order || 20).class"
                                        >
                                            <i class="fas text-[9px]" :class="getScaleBadge(quantities[pkg.id || pkg.package_id], pkg.min_order || 20).icon"></i>
                                    ...
                                    <div class="border-t border-[#E6E1DA] pt-4 space-y-2.5">
                                        ...
                                        <div class="bg-[#FAF7F2] p-4 rounded-xl border border-[#E6E1DA] flex items-center justify-between mt-2 shadow-2xs">
                                            <span class="text-xs font-bold text-[#4A6B5D] uppercase tracking-wider">{{ t('live_total') }}:</span>
                                ...
                                <div class="flex flex-col gap-2">
                                    <Link 
                                        ...
                                        class="btn-premium-primary w-full inline-flex items-center justify-center gap-2 bg-[#4A6B5D] hover:bg-[#3D574B] text-white font-semibold py-3.5 px-6 rounded-xl text-xs uppercase tracking-widest shadow-sm text-center cursor-pointer"
                                    >
                                    ...
                                    <button 
                                        ...
                                        class="btn-premium-secondary w-full inline-flex items-center justify-center gap-2 bg-white border border-[#E6E1DA] text-[#5C6460] font-semibold py-3.5 px-6 rounded-xl text-xs uppercase tracking-widest cursor-pointer"
