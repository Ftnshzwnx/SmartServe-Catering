...
<template>
    ...
    <FrontLayout :canLogin="canLogin" :canRegister="canRegister">
        <!-- Page Hero -->
        <section class="relative bg-[#1C201E] text-white overflow-hidden py-28 lg:py-40 font-sans-modern">
            ...
            <div class="relative max-w-7xl mx-auto px-6 lg:px-8 text-center space-y-6 z-10">
                ...
                <p class="text-base text-[#8E9993] max-w-xl mx-auto font-light leading-relaxed">
                    {{ t('about_desc_1') }}
                </p>
            </div>
        </section>
        ...
        <!-- Our Story Section -->
        <section class="py-24 bg-white border-b border-[#E6E1DA] font-sans-modern">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    <!-- Left: Image -->
                    <div class="lg:col-span-5">
                        <div class="relative">
                            <div class="aspect-[4/5] bg-[#EADED9] overflow-hidden rounded-2xl shadow-lg">
                                <img
                    ...
                    <div class="lg:col-span-7 space-y-8">
                        ...
                        <div class="space-y-5 text-[#5C6460] font-light leading-relaxed text-sm md:text-base">
                            <p>{{ t('about_desc_1') }}</p>
                            <p>{{ t('about_desc_2') }}</p>
                            <p class="text-sm text-[#8C8275] italic border-l-2 border-[#4A6B5D] pl-4">
                                {{ t('about_quote') }}
                            </p>
                        </div>
                    </div>
        ...
        <section class="py-20 bg-[#FAF7F2] border-b border-[#E6E1DA] font-sans-modern">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="text-center mb-14 space-y-2">
                    <span class="text-xs font-semibold text-[#8C8275] tracking-widest uppercase block">{{ t('milestones_tag') }}</span>
                    <h2 class="text-3xl lg:text-4xl font-light text-[#1C201E] font-serif-luxury uppercase tracking-wider">
                        {{ t('achievements_title') }}
                    </h2>
                </div>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div class="text-center space-y-3 bg-white border border-[#E6E1DA] rounded-2xl p-8 hover:-translate-y-1 hover:shadow-md transition-all duration-300">
        ...
        <section class="py-24 bg-white border-b border-[#E6E1DA] font-sans-modern">
            <div class="max-w-7xl mx-auto px-6 lg:px-8 space-y-14">
                <div class="text-center space-y-3">
                    <span class="text-xs font-semibold text-[#4A6B5D] tracking-widest uppercase block">{{ t('values_title') }}</span>
                    <h2 class="text-3xl lg:text-4xl font-light text-[#1C201E] font-serif-luxury uppercase tracking-wider">
                        {{ t('values_title') }}
                    </h2>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-[#FAF7F2] border border-[#E6E1DA] rounded-3xl p-8 space-y-4 hover:-translate-y-2 hover:shadow-lg transition-all duration-300 group">
                        <div class="w-14 h-14 rounded-2xl bg-[#EBEFEF] text-[#4A6B5D] flex items-center justify-center text-xl font-bold group-hover:bg-[#4A6B5D] group-hover:text-white transition-colors duration-300">
                            <i class="fas fa-leaf"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('value_1_title') }}</h3>
                        <p class="text-sm text-[#5C6460] leading-relaxed font-light">{{ t('value_1_desc') }}</p>
                    </div>
                    <div class="bg-[#FAF7F2] border border-[#E6E1DA] rounded-3xl p-8 space-y-4 hover:-translate-y-2 hover:shadow-lg transition-all duration-300 group">
                        <div class="w-14 h-14 rounded-2xl bg-[#EBEFEF] text-[#4A6B5D] flex items-center justify-center text-xl font-bold group-hover:bg-[#4A6B5D] group-hover:text-white transition-colors duration-300">
                            <i class="fas fa-star"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('value_2_title') }}</h3>
                        <p class="text-sm text-[#5C6460] leading-relaxed font-light">{{ t('value_2_desc') }}</p>
                    </div>
                    <div class="bg-[#FAF7F2] border border-[#E6E1DA] rounded-3xl p-8 space-y-4 hover:-translate-y-2 hover:shadow-lg transition-all duration-300 group">
                        <div class="w-14 h-14 rounded-2xl bg-[#EBEFEF] text-[#4A6B5D] flex items-center justify-center text-xl font-bold group-hover:bg-[#4A6B5D] group-hover:text-white transition-colors duration-300">
                            <i class="fas fa-handshake"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('value_3_title') }}</h3>
                        <p class="text-sm text-[#5C6460] leading-relaxed font-light">{{ t('value_3_desc') }}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-24 bg-[#FAF7F2] font-sans-modern">
            <div class="max-w-4xl mx-auto px-6 lg:px-8 space-y-14">
                <div class="text-center space-y-3">
                    <span class="text-xs font-semibold text-[#4A6B5D] tracking-widest uppercase block">{{ t('milestones_title') }}</span>
                    <h2 class="text-3xl lg:text-4xl font-light text-[#1C201E] font-serif-luxury uppercase tracking-wider">
                ...
                <div class="relative">
                    ...
                    <div class="space-y-12">
                        ...
                        <div class="relative flex flex-col md:flex-row md:items-center gap-6 md:gap-12">
                            ...
                            <div class="absolute left-0 md:relative md:left-auto flex-shrink-0 w-8 h-8 rounded-full bg-[#4A6B5D] border-4 border-[#FAF7F2] md:mx-0 flex items-center justify-center">
                        ...
                        <div class="relative flex flex-col md:flex-row md:items-center gap-6 md:gap-12">
                            ...
                            <div class="absolute left-0 md:relative md:left-auto flex-shrink-0 w-8 h-8 rounded-full bg-[#4A6B5D] border-4 border-[#FAF7F2] flex items-center justify-center">
                                <div class="w-2 h-2 rounded-full bg-white"></div>
                            </div>
                        ...
                        <div class="relative flex flex-col md:flex-row md:items-center gap-6 md:gap-12">
                            <div class="hidden md:block md:w-1/2 md:text-right md:pr-10"></div>
                            <div class="absolute left-0 md:relative md:left-auto flex-shrink-0 w-8 h-8 rounded-full bg-[#1C201E] border-4 border-[#FAF7F2] flex items-center justify-center">
                                <div class="w-2 h-2 rounded-full bg-white"></div>
                            </div>
                            <div class="md:w-1/2 md:pl-10 pl-12">
                                <div class="text-[10px] text-[#4A6B5D] font-bold uppercase tracking-widest mb-1">{{ t('now_label') }}</div>
                                <h3 class="text-lg font-semibold text-[#1C201E] font-serif-luxury">{{ t('journey_now_title') }}</h3>
                                <p class="text-xs text-[#5C6460] font-light leading-relaxed mt-2">
                                    {{ t('journey_now_desc') }}
                                </p>
                            </div>
