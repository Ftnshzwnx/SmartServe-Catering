...
<template>
    ...
    <FrontLayout :canLogin="canLogin" :canRegister="canRegister">
        ...
        <header class="relative overflow-hidden py-8 sm:py-16 lg:py-28 font-sans-modern">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-12 gap-6 lg:gap-8 items-center">

                    <!-- Left Column: Copy -->
                    <div class="lg:col-span-7 space-y-4 sm:space-y-8 text-left z-10">
                        ...
                        <h1 class="text-xl sm:text-5xl lg:text-7xl font-light tracking-tight text-[#1C201E] leading-[1.1] font-serif-luxury">
                            {{ t('hero_title_1') }} <br />
                            <span class="italic text-[#4A6B5D]">{{ t('hero_title_2') }}</span><br />
                            {{ t('hero_title_3') }}
                        </h1>

                        <p class="text-[10px] sm:text-base lg:text-lg text-[#5C6460] leading-relaxed max-w-xl font-light">
                            {{ t('hero_desc') }}
                        </p>
        ...
        <section class="py-10 sm:py-24 bg-white border-y border-[#E6E1DA] font-sans-modern">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-16">
                <!-- Two-Column Header -->
                <div class="grid lg:grid-cols-12 gap-6 sm:gap-12 items-start">
                    <div class="lg:col-span-5 space-y-2 sm:space-y-4">
                        <span class="text-[#4A6B5D] font-bold text-xs uppercase tracking-widest block">{{ t('about_subtitle') }}</span>
                        <h2 class="text-lg sm:text-4xl lg:text-5xl font-light text-[#1C201E] font-serif-luxury leading-tight">
                            {{ t('about_title_1') }} <br />
                            <span class="italic text-[#4A6B5D]">{{ t('about_title_2') }}</span>
                        </h2>
                    </div>
                    <div class="lg:col-span-7 space-y-3 sm:space-y-6 text-[#5C6460] font-light leading-relaxed text-[10px] sm:text-sm md:text-base">
                        <p>{{ t('about_desc_1') }}</p>
                        <p>{{ t('about_desc_2') }}</p>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 sm:py-12 border-y border-[#E6E1DA]/60">
                    <div class="text-center space-y-2">
                        <div class="text-lg sm:text-3xl lg:text-5xl font-light text-[#4A6B5D] font-serif-luxury">500+</div>
                        <div class="text-[9px] sm:text-[10px] font-semibold text-[#8C8275] uppercase tracking-widest">{{ t('stats_events') }}</div>
                    </div>
                    <div class="text-center space-y-2">
                        <div class="text-lg sm:text-3xl lg:text-5xl font-light text-[#4A6B5D] font-serif-luxury">10,000+</div>
                        <div class="text-[9px] sm:text-[10px] font-semibold text-[#8C8275] uppercase tracking-widest">{{ t('stats_guests') }}</div>
                    </div>
                    <div class="text-center space-y-2">
                        <div class="text-lg sm:text-3xl lg:text-5xl font-light text-[#4A6B5D] font-serif-luxury">100%</div>
                        <div class="text-[9px] sm:text-[10px] font-semibold text-[#8C8275] uppercase tracking-widest">{{ t('stats_halal') }}</div>
                    </div>
                    <div class="text-center space-y-2">
                        <div class="text-lg sm:text-3xl lg:text-5xl font-light text-[#4A6B5D] font-serif-luxury">15+</div>
                ...
                <div class="space-y-4 sm:space-y-8">
                    ...
                    <div class="grid md:grid-cols-3 gap-3 sm:gap-8">
                        <div class="bg-[#FAF7F2] border border-[#E6E1DA] rounded-xl sm:rounded-2xl p-3 sm:p-6 space-y-1.5 sm:space-y-3 hover:-translate-y-1 hover:shadow-md transition-all duration-300">
        ...
        <section class="py-10 sm:py-20 bg-[#FAF7F2] border-b border-[#E6E1DA] font-sans-modern">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    <div class="space-y-3 sm:space-y-5">
                        ...
                        <p class="text-[10px] sm:text-sm text-[#5C6460] font-light leading-relaxed max-w-md">
                            {{ t('packages_subtitle') }}
                        </p>
                        <Link
                            href="/packages"
                            class="inline-flex items-center gap-2 bg-[#4A6B5D] hover:bg-[#3D574B] text-white px-3 py-2 sm:px-8 sm:py-4 rounded-lg sm:rounded-xl text-[9px] sm:text-xs font-semibold uppercase tracking-widest transition-all duration-200 shadow-md"
                        >
                    ...
                    <div class="grid grid-cols-3 gap-2 sm:gap-4">
                        <div class="bg-white border border-[#E6E1DA] rounded-lg sm:rounded-2xl overflow-hidden shadow-xs hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <div class="bg-white border border-[#E6E1DA] rounded-lg sm:rounded-2xl overflow-hidden shadow-xs hover:-translate-y-1 transition-transform duration-300 mt-3 sm:mt-6">
                            <div class="aspect-square bg-[#EADED9] overflow-hidden">
        ...
        <section id="policies" class="py-10 sm:py-24 bg-white border-t border-[#E6E1DA] font-sans-modern">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-14">
                ...
                <div class="text-center space-y-2 animate-fade-in">
                    ...
                    <h2 class="text-lg sm:text-3xl lg:text-4xl font-light text-[#1C201E] font-serif-luxury uppercase tracking-wider">
                        {{ t('booking_policies_title') }}
                    </h2>
                    <p class="text-[10px] sm:text-xs text-[#8C8275] max-w-md mx-auto font-light leading-relaxed">
                        {{ t('booking_policies_subtitle') }}
                    </p>
                </div>

                <!-- Policy Cards Grid -->
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-6">

                    <!-- Policy Card 1: Deposit -->
                    <div class="group bg-[#FAF7F2] border border-[#E6E1DA] rounded-xl p-3 sm:p-7 space-y-2.5 sm:space-y-5 hover:-translate-y-1 hover:shadow-lg hover:border-[#4A6B5D]/30 transition-all duration-300">
                        <div class="flex items-start justify-between">
                            <div class="w-8 h-8 sm:w-12 sm:h-12 rounded-lg sm:rounded-2xl bg-[#EBEFEF] group-hover:bg-[#4A6B5D] text-[#4A6B5D] group-hover:text-white flex items-center justify-center text-xs sm:text-base transition-all duration-300">
                                <i class="fas fa-money-bill-wave"></i>
                            </div>
                            <span class="text-[9px] sm:text-[10px] font-bold text-[#8C8275] uppercase tracking-widest bg-white border border-[#E6E1DA] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full">01</span>
                        </div>
                        <div class="space-y-1 sm:space-y-2">
                            <h3 class="text-xs sm:text-base font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('policy_header_1') }}</h3>
                            <p class="text-[9px] sm:text-xs text-[#5C6460] leading-relaxed font-light">{{ t('policy_desc_1') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="group bg-[#FAF7F2] border border-[#E6E1DA] rounded-xl p-3 sm:p-7 space-y-2.5 sm:space-y-5 hover:-translate-y-1 hover:shadow-lg hover:border-[#4A6B5D]/30 transition-all duration-300">
                        <div class="flex items-start justify-between">
                            ...
                            <span class="text-[9px] sm:text-[10px] font-bold text-[#8C8275] uppercase tracking-widest bg-white border border-[#E6E1DA] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full">02</span>
                        </div>
                        <div class="space-y-1 sm:space-y-2">
                            <h3 class="text-xs sm:text-base font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('policy_header_2') }}</h3>
                            <p class="text-[9px] sm:text-xs text-[#5C6460] leading-relaxed font-light">{{ t('policy_desc_2') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="group bg-[#FAF7F2] border border-[#E6E1DA] rounded-xl p-3 sm:p-7 space-y-2.5 sm:space-y-5 hover:-translate-y-1 hover:shadow-lg hover:border-[#4A6B5D]/30 transition-all duration-300">
                        <div class="flex items-start justify-between">
                            ...
                            <span class="text-[9px] sm:text-[10px] font-bold text-[#8C8275] uppercase tracking-widest bg-white border border-[#E6E1DA] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full">03</span>
                        </div>
                        <div class="space-y-1 sm:space-y-2">
                            <h3 class="text-xs sm:text-base font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('policy_header_3') }}</h3>
                            <p class="text-[9px] sm:text-xs text-[#5C6460] leading-relaxed font-light">{{ t('policy_desc_3') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="group bg-[#FAF7F2] border border-[#E6E1DA] rounded-xl p-3 sm:p-7 space-y-2.5 sm:space-y-5 hover:-translate-y-1 hover:shadow-lg hover:border-[#4A6B5D]/30 transition-all duration-300">
                        <div class="flex items-start justify-between">
                            ...
                            <span class="text-[9px] sm:text-[10px] font-bold text-[#8C8275] uppercase tracking-widest bg-white border border-[#E6E1DA] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full">04</span>
                        </div>
                        <div class="space-y-1 sm:space-y-2">
                            <h3 class="text-xs sm:text-base font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('policy_header_4') }}</h3>
                            <p class="text-[9px] sm:text-xs text-[#5C6460] leading-relaxed font-light">{{ t('policy_desc_4') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="group bg-[#FAF7F2] border border-[#E6E1DA] rounded-xl p-3 sm:p-7 space-y-2.5 sm:space-y-5 hover:-translate-y-1 hover:shadow-lg hover:border-[#4A6B5D]/30 transition-all duration-300">
                        <div class="flex items-start justify-between">
                            ...
                            <span class="text-[9px] sm:text-[10px] font-bold text-[#8C8275] uppercase tracking-widest bg-white border border-[#E6E1DA] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full">05</span>
                        </div>
                        <div class="space-y-1 sm:space-y-2">
                            <h3 class="text-xs sm:text-base font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('policy_header_5') }}</h3>
                            <p class="text-[9px] sm:text-xs text-[#5C6460] leading-relaxed font-light">{{ t('policy_desc_5') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="group bg-[#FAF7F2] border border-[#E6E1DA] rounded-xl p-3 sm:p-7 space-y-2.5 sm:space-y-5 hover:-translate-y-1 hover:shadow-lg hover:border-[#4A6B5D]/30 transition-all duration-300">
                        <div class="flex items-start justify-between">
                            ...
                            <span class="text-[9px] sm:text-[10px] font-bold text-[#8C8275] uppercase tracking-widest bg-white border border-[#E6E1DA] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full">06</span>
                        </div>
                        <div class="space-y-1 sm:space-y-2">
                            <h3 class="text-xs sm:text-base font-semibold text-[#1C201E] font-serif-luxury uppercase tracking-wider">{{ t('policy_header_6') }}</h3>
                            <p class="text-[9px] sm:text-xs text-[#5C6460] leading-relaxed font-light">{{ t('policy_desc_6') }}</p>
                        </div>
                    </div>
                </div>

                <!-- Trust Footer Banner -->
                <div class="bg-[#1C201E] rounded-xl sm:rounded-3xl p-3 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
                    <div class="flex items-center gap-3 sm:gap-4 w-full md:w-auto">
                        <div class="w-8 h-8 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-[#4A6B5D]/30 text-[#A8C5B8] flex items-center justify-center text-xs sm:text-lg flex-shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-[#8E9993] text-[9px] sm:text-xs font-light mt-0.5 leading-relaxed">
                    ...
                    <Link
                        href="/contact"
                        class="w-full md:w-auto flex-shrink-0 bg-[#4A6B5D] hover:bg-[#3D574B] text-white px-3 py-2 sm:px-7 sm:py-3 rounded-lg sm:rounded-xl text-[9px] sm:text-xs font-semibold uppercase tracking-widest transition-colors duration-200 whitespace-nowrap text-center justify-center"
                    >
                        {{ t('ask_us') }}
                    </Link>
                </div>
        ...
        <!-- FAQ CTA Section -->
        <section class="py-10 sm:py-20 bg-[#FAF7F2] border-t border-[#E6E1DA] font-sans-modern">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-6 sm:gap-12 items-center">
                    <div class="space-y-3 sm:space-y-5">
                        ...
                        <Link
                            href="/faq"
                            class="inline-flex items-center gap-2 bg-[#4A6B5D] hover:bg-[#3D574B] text-white px-3 py-2 sm:px-8 sm:py-4 rounded-lg sm:rounded-xl text-[9px] sm:text-xs font-semibold uppercase tracking-widest transition-all duration-200 shadow-md w-full sm:w-auto text-center justify-center"
                        >
                    ...
                    <div class="space-y-2 sm:space-y-3">
                        <div class="bg-white border border-[#E6E1DA] rounded-lg px-3 py-2.5 sm:rounded-2xl sm:px-6 sm:py-4 flex items-center justify-between shadow-xs hover:border-[#4A6B5D]/40 transition-colors">
                            <span class="text-[10px] sm:text-sm font-medium text-[#1C201E]">{{ t('q_min_guests') }}</span>
                            <i class="fas fa-chevron-right text-[10px] text-[#8C8275]"></i>
                        </div>
                        <div class="bg-white border border-[#E6E1DA] rounded-lg px-3 py-2.5 sm:rounded-2xl sm:px-6 sm:py-4 flex items-center justify-between shadow-xs hover:border-[#4A6B5D]/40 transition-colors">
                            <span class="text-[10px] sm:text-sm font-medium text-[#1C201E]">{{ t('q_halal') }}</span>
                            <i class="fas fa-chevron-right text-[10px] text-[#8C8275]"></i>
                        </div>
                        <div class="bg-white border border-[#E6E1DA] rounded-lg px-3 py-2.5 sm:rounded-2xl sm:px-6 sm:py-4 flex items-center justify-between shadow-xs hover:border-[#4A6B5D]/40 transition-colors">
                            <span class="text-[10px] sm:text-sm font-medium text-[#1C201E]">{{ t('q_menu_change') }}</span>
                            <i class="fas fa-chevron-right text-[10px] text-[#8C8275]"></i>
                        </div>
                        <div class="bg-white border border-[#E6E1DA] rounded-lg px-3 py-2.5 sm:rounded-2xl sm:px-6 sm:py-4 flex items-center justify-between shadow-xs hover:border-[#4A6B5D]/40 transition-colors">
                            <span class="text-[10px] sm:text-sm font-medium text-[#1C201E]">{{ t('q_payment') }}</span>
                            <i class="fas fa-chevron-right text-[10px] text-[#8C8275]"></i>
                        </div>
                    </div>
                </div>
        ...
        <section v-if="reviews && reviews.length > 0" id="testimonials" class="py-10 sm:py-24 bg-[#FAF7F2] border-t border-[#E6E1DA] font-sans-modern overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-14">
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-10">
                    ...
                    <div class="flex-shrink-0 bg-white border border-[#E6E1DA] rounded-lg sm:rounded-3xl px-4 py-2.5 sm:px-8 sm:py-6 text-center shadow-sm min-w-[120px] sm:min-w-[160px] w-full sm:w-auto">
                        <div class="text-2xl sm:text-5xl font-light text-[#2D3330] font-serif-luxury leading-none mb-1 sm:mb-2">
                ...
                <div class="relative w-full overflow-hidden py-4 select-none">
                    ...
                    >
                        <div
                            ...
                            :key="`${review.id}-${index}`"
                            class="w-[280px] sm:w-[360px] flex-shrink-0 bg-white border border-[#E6E1DA] rounded-lg p-3 sm:rounded-2xl sm:p-6 shadow-sm flex flex-col justify-between space-y-3 sm:space-y-5 hover:border-[#C5A880]/50 hover:shadow-md transition-all duration-300"
                        >
                            <!-- Top: Stars + Quote -->
        ...
        <!-- Contact CTA Section -->
        <section id="contact" class="py-10 sm:py-24 bg-white border-t border-[#E6E1DA] font-sans-modern text-center">
            <div class="max-w-2xl mx-auto px-4 sm:px-6 space-y-4 sm:space-y-6">
                <span class="text-[10px] text-[#4A6B5D] uppercase tracking-widest font-bold block">{{ t('contact_us') }}</span>
                <h2 class="text-lg sm:text-3xl lg:text-5xl font-light text-[#1C201E] font-serif-luxury leading-tight">
                    {{ t('contact_title') }}
                </h2>
