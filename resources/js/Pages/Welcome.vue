    ...
    <FrontLayout :canLogin="canLogin" :canRegister="canRegister">
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    ...
                    <div class="lg:col-span-7 space-y-8 text-left z-10">
                        ...
                        <div class="grid grid-cols-2 gap-2.5 sm:flex sm:flex-row sm:gap-4 pt-4">
                            <Link
                            ...
                            <Link
                                href="/about"
                                class="bg-transparent hover:bg-[#FAF7F2] border border-[#D1C8BD] text-[#2D3330] text-center px-4 py-2.5 sm:px-8 sm:py-4 rounded-lg sm:rounded-xl text-[10px] sm:text-xs font-semibold uppercase tracking-widest transition-all duration-200 flex items-center justify-center"
                            >
                                {{ t('read_story') }}
                            </Link>
                        </div>
        ...
        <section id="contact" class="py-16 sm:py-24 bg-white border-t border-[#E6E1DA] font-sans-modern text-center">
            <div class="max-w-2xl mx-auto px-6 space-y-5 sm:space-y-6">
                ...
                <div class="grid grid-cols-2 gap-2.5 sm:flex sm:flex-row sm:gap-4 justify-center pt-4">
                    <Link
                        href="/contact"
                        class="bg-[#4A6B5D] hover:bg-[#3D574B] text-white text-center px-4 py-2.5 sm:px-10 sm:py-4 rounded-lg sm:rounded-xl text-[10px] sm:text-xs font-semibold uppercase tracking-widest transition-all duration-200 shadow-md flex items-center justify-center animate-scale-up"
                    >
                        {{ t('contact_submit') }}
                    </Link>
                    <a
                        ...
                        target="_blank"
                        class="bg-emerald-600 hover:bg-emerald-700 text-white text-center px-4 py-2.5 sm:px-10 sm:py-4 rounded-lg sm:rounded-xl text-[10px] sm:text-xs font-semibold uppercase tracking-widest transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2 shadow-md"
                    >
