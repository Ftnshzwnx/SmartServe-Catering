...
<a href="{{ $url }}" style="display: inline-block; text-decoration: none;">
    ...
    <br>
    <span style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; font-size: 8px; font-weight: bold; letter-spacing: 0.25em; text-transform: uppercase; color: #8C8275; margin-top: 4px; display: inline-block; line-height: 1;">
        Catering
    </span>
</a>
</td>
